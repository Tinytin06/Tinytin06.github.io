...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description='Converts a Tiled JSON file into a more usable file by finding all of the object layers. It assumes that the name of the object layer is the same as the object.')
